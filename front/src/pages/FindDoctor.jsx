      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-100 p-4 sm:p-6 md:p-8 lg:p-10 mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">Search Filters</h2>
          </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-gray-100 p-4 sm:p-6 md:p-8 lg:p-10">
          ...
          {loading ? (
            <div className="text-center py-12 sm:py-16">
              ...
              <p className="text-sm sm:text-base text-gray-500">Searching doctors…</p>
            </div>
          ) : doctors.length === 0 && (filters.name || filters.department || filters.council || filters.registration_number) ? (
            <div className="text-center py-12 sm:py-16">
              <span className="material-symbols-outlined text-5xl sm:text-6xl text-gray-400 mb-3 sm:mb-4 block">person_search</span>
            ...
            <div className="text-center py-12 sm:py-16">
              <span className="material-symbols-outlined text-5xl sm:text-6xl text-gray-400 mb-3 sm:mb-4 block">search</span>
              <p className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
                Start Your Search
              </p>
              <p className="text-sm sm:text-base text-gray-500 px-4">
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
                      <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-dark)] 
                                   flex items-center justify-center text-white shadow-lg shrink-0">
                        <span className="material-symbols-outlined text-2xl sm:text-3xl md:text-4xl">person</span>
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 group-hover:text-[var(--color-primary)] transition duration-300 mb-2 break-words">
                          {doctor.name}
                        </h3>
                        {doctor.designation && (
                          <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mb-1 break-words">
                            {doctor.designation}
                          </p>
                        )}
                        {doctor.specialization && (
                          <p className="text-xs sm:text-sm text-gray-600 mb-2 flex items-center gap-1 break-words">
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3 mt-2 sm:mt-3">
                          {doctor.registration_council && (
                            <span className="px-2 sm:px-3 py-1 bg-blue-50 text-blue-700 rounded-lg text-xs sm:text-sm font-medium flex items-center gap-1">
                              <span className="material-symbols-outlined text-xs sm:text-sm">verified</span>
                              {doctor.registration_council}
                            </span>
                          )}
                          {doctor.registration_number && (
                            <span className="px-2 sm:px-3 py-1 bg-green-50 text-green-700 rounded-lg text-xs sm:text-sm font-medium flex items-center gap-1">
                          ...
                          {doctor.verification_status === "verified" && (
                            <span className="px-2 sm:px-3 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-xs sm:text-sm font-medium flex items-center gap-1">
                        ...
                        {doctor.hospital_affiliation && (
                          <p className="text-xs sm:text-sm text-gray-500 mt-2 sm:mt-3 flex items-center gap-1 break-words">
                            <span className="material-symbols-outlined text-xs sm:text-sm">local_hospital</span>
                            {doctor.hospital_affiliation}
                          </p>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center justify-end sm:justify-start gap-2 sm:gap-3 shrink-0">
